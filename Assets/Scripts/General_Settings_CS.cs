...
namespace ChobiAssets.KTP
{
    ...
    public class General_Settings_CS
    {
        ...
        public static float fixedTimestepMobile = 1.0f / 60.0f;

        // General Function settings.
        public static bool allowInstantQuit = true;
        public static bool allowReloadScene = true;
        public static bool allowSwitchCursor = false;
